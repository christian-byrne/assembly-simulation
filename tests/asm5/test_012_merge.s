...
MAIN_TESTCASE:
    la      $a0, MERGE_DATA       # arg1: DATA
    addi    $a1, $zero, 2         # arg2:   2
    addi    $a2, $a0,8            # arg3: DATA+2
    addi    $a3, $zero,30         # arg4:  30
    ...
    la      $a2, MERGE_DATA       # arg3: DATA
    addi    $a3, $zero, 2         # arg4:   2
    addi    $a0, $a2,8            # arg1: DATA+2
    addi    $a1, $zero,30         # arg2:  30
    la      $t0, MERGE_OUT_DATA   # arg5: OUT_DATA
    sw      $t0, -4($sp)
    jal     merge
    ...
    la      $a0, MERGE_DATA       # arg1: DATA
    addi    $a1, $zero,16         # arg2:  16
    addi    $a2, $a0,64           # arg3: DATA+16
    addi    $a3, $zero,16         # arg4:  16
    la      $t0, MERGE_OUT_DATA   # arg5: OUT_DATA
    sw      $t0, -4($sp)
    jal     merge
