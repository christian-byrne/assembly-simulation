...
ARR_DUP_DATA_1:
    ...
    .word   58
.text
    la      $a0, ARR_DUP_DATA_1
    addi    $a1, $zero,8          # arg2: len
    addi    $a2, $zero,58
    jal     arrayDupSearchInts    # should fail, because the dup is indices 7,8
...
.data
TESTCASE_TAIL_MSG: .asciiz "This is the tail message, with trailing constant 0x2774\n"
.text
    addi    $v0, $zero,4
